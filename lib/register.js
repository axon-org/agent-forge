...
function renderRegisterConfig(agentId, options = {}) {
  ...
  lines.push(`${commentPrefix} If this agent needs channel routing, add a bindings[] entry:`);
  lines.push(`${commentPrefix}   { agentId: "${agentId}", match: { channel: "<channel>", accountId: "<account>" } }`);
